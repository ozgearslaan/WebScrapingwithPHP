...
class capture extends dbsetting{
       ...
       public function sube_kaydet($eczaneadi,$eczaneiladi,$eczaneilceadi,$eczaneadres,$enlem,$boylam, $baslangic, $bitis, $glnno, $id) {
              $query = "insert into dun_nobetci (eczaneadi,eczaneiladi,eczaneilceadi,eczaneadres,baslangic,bitis,glnno,id,geog) values ('$eczaneadi','$eczaneiladi','$eczaneilceadi','$eczaneadres','$baslangic','$bitis', $glnno, $id ,ST_SetSRID(ST_MakePoint($boylam,$enlem),4326))";
              print ($query."\n");
